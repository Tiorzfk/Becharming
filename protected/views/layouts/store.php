...
<!-- Mirrored from webpentagon.com/demo/themeforest/html/bestshop/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jun 2015 11:34:29 GMT -->
<head>
...
<script>(function(d, s, id) {
      ...
      <div class="container main">
          ...
          <div class="header_top">
            ...
            <div class="call_info span4">
              <p>SELAMAT DATANG DI <span class="color">BECHARMING FASHION</span></p>
        ...
        <ul class="row">
          <li class="follow-us span4">
            ...
            <div class="social-icon">
              <ul>
                <li class="fb">
                  <a href="#"><img alt="" src="<?php echo Yii::app()->request->baseUrl;?>/assets/theme/frontend/images/social/facebook.png"></a>
                </li>
                <li class="tw">
              ...
              <div class="widget-info">
                ...
                <div class="widget-content">
                  <ul>
                    ...
                    <li><a href="#">Cek Ongkir & Resi</a></li>
  ...
  <script>
   $(document).ready(function(){
     ...
     var navHeight = $( window ).height() - 540;
