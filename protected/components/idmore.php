<?php
class Idmore extends CUserIdentity{
	private $key;
	public function __construct()
	{
		//masukan api key disini
		$this->key = 'b0b90bedce1f1a8daf29d1f8981f0359';	
	}
	...
	public function showResult($province,$city)
	{
		$curl = curl_init();
		curl_setopt_array($curl, array(
			CURLOPT_URL => "http://rajaongkir.com/api/starter/city?id=$city&province=$province",
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => "",
			CURLOPT_MAXREDIRS => 10,
			CURLOPT_TIMEOUT => 30,
